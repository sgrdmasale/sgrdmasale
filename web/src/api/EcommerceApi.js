...
const ECOMMERCE_STORE_ID = "store_01KPDFSMPTB26JR9GKTV4EPZ9A";
...
export const formatCurrency = (priceInCents, currencyInfo) => {
  ...
  // Default to Indian Rupee when no explicit currency info is supplied.
  const info = currencyInfo || { symbol: "₹" };
  const { code, symbol, template, decimal_digits } = info;
